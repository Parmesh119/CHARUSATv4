...
import Convocation_01_Guest from "../assets/images/convocations/APJ.jpg";
import Convocation_02_Guest from "../assets/images/convocations/dr_r_a_mashelkar.jpg";
import Convocation_03_Guest from "../assets/images/convocations/Mr.-Pankaj-Patel.jpg";
import Convocation_04_Guest from "../assets/images/convocations/Dr.-T.-Ramasami.jpg";
import Convocation_05_Guest from "../assets/images/convocations/O-P-Kohli.jpg";
import Convocation_06_Guest from "../assets/images/convocations/Dr.-M.-I.-Patel.jpg";
import Convocation_07_Guest from "../assets/images/convocations/Kiran-Kumar.jpg";
import Convocation_08_Guest from "../assets/images/convocations/SUN1917.jpg";
                            ...
                            <Container style={{ "text-align": "justify" }}>
                              ...
                              <Row className="p-2">
                                ...
                                <Col md={10}>
                                  <p>
                                    ...
                                    different Gold Medals. The occasion was
                                    graced by the presence of Dr Bimal Patel,
                                    Member, International Law Commission, and UN
                                    & Vice-Chancellor Rashtriya Raksha
                                    University.
                                  </p>
                                </Col>
                              </Row>
                              ...
                              <Row className="p-2">
                                <Col>
                                  <hr />
                                  <h6 className="  p-1">
                                    09<sup>th</sup> Convocation – Hon’ble Arif
                                    Mohammed Khan
                                  </h6>
                                </Col>
                              </Row>
                              <Row className="p-2">
                                ...
                                <Col md={10}>
                                  <p>
                                    ...
                                    delivered the convocation address. Dr George
                                    Musser, a renowned American writer and a
                                    contributing editor for ‘Scientific
                                    American’ magazine, was the Guest of Honour
                                    for the event.
                                  </p>
                                </Col>
                              </Row>
                              <Row className="p-2">
                                <Col>
                                  <hr />
                                  <h6 className="  p-1">
                                    08<sup>th</sup> Convocation – Dr. R
                                    Chidambaram
                                  </h6>
                                </Col>
                              </Row>
                              <Row className="p-2">
                                ...
                                <Col md={10}>
                                  <p>
                                    ...
                                    Computer Science and Applications, Faculty
                                    of Pharmacy, Faculty of Management Studies,
                                    Faculty of Applied Sciences, and Faculty of
                                    Medical Sciences were awarded the degrees.
                                    In all, 34 gold medals were awarded to the
                                    deserving students. The 8th Convocation was
                                    an important landmark for CHARUSAT as 30 PhD
                                    Scholars were awarded degrees. It was graced
                                    by the presence of Dr. R Chidambaram, Padma
                                    Vibhushan and Padma Shri as the Chief Guest.
                                  </p>
                                </Col>
                              </Row>
                              ...
                              <Row className="p-2">
                                <Col>
                                  <hr />
                                  <h6 className="  p-1">
                                    07<sup>th</sup> Convocation – Shri. A S
                                    Kiran Kumar
                                  </h6>
                                </Col>
                              </Row>
                              <Row className="p-2">
                                ...
                                <Col md={10}>
                                  <p>
                                    ...
                                    of Pharmacy, Faculty of Management Studies,
                                    Faculty of Applied Sciences, and Faculty of
                                    Medical Sciences were awarded with the
                                    degrees. In all, 35 gold medals were awarded
                                    to the deserving students. The 7th
                                    Convocation was an important landmark for
                                    CHARUSAT as 46 Ph.D. Scholars were awarded
                                    degrees It was graced by the presence of
                                    Shri. A S Kiran Kumar, Chairman, ISRO as the
                                    Chief Guest.
                                  </p>
                                </Col>
                              </Row>
                              <Row className="p-2">
                                <Col>
                                  <hr />
                                  <h6 className="  p-1">
                                    06<sup>th</sup> Convocation – Dr. M I Patel
                                  </h6>
                                </Col>
                              </Row>
                              <Row className="p-2">
                                ...
                                <Col md={10}>
                                  <p>
                                    ...
                                    Faculty of Applied Sciences, and Faculty of
                                    Medical Sciences were awarded with the
                                    degrees. In all, 29 gold medals were awarded
                                    to the deserving students. The 6th
                                    Convocation was an important landmark for
                                    CHARUSAT as 21 Ph D Scholars were awarded
                                    degrees It was graced by the presence of Dr.
                                    M I Patel, Former Sheriff, Mumbai as the
                                    Chief Guest.
                                  </p>
                                </Col>
                              </Row>
                              <Row className="p-2">
                                <Col>
                                  <hr />
                                  <h6 className="  p-1">
                                    05<sup>th</sup> Convocation – Shri. O P
                                    Kohli
                                  </h6>
                                </Col>
                              </Row>
                              <Row className="p-2">
                                ...
                                <Col md={10}>
                                  <p>
                                    ...
                                    Faculty of Applied Sciences, and Faculty of
                                    Medical Sciences were awarded with the
                                    degrees. In all, 27 gold medals were awarded
                                    to the deserving students. The 5th
                                    Convocation was an important landmark for
                                    CHARUSAT as 7 Ph D Scholars were awarded
                                    degrees It was graced by the presence of
                                    Shri. O P Kohli, Hon. Governorshree of
                                    Gujarat as the Chief Guest.
                                  </p>
                                </Col>
                              </Row>
                              <Row className="p-2">
                                <Col>
                                  <hr />
                                  <h6 className="  p-1">
                                    04<sup>th</sup> Convocation – Dr. T.
                                    Ramasami
                                  </h6>
                                </Col>
                              </Row>
                              <Row className="p-2">
                                ...
                                <Col md={10}>
                                  <p>
                                    ...
                                    Medical Sciences were awarded with the
                                    degrees. In all, 27 gold medals were awarded
                                    to the deserving students. It was graced by
                                    the presence of Padma Shri and Padma Bhushan
                                    Dr. T. Ramasami, Former Secretary,
                              ...
                              <Row className="p-2">
                                <Col>
                                  <hr />
                                  <h6 className="  p-1">
                                    03<sup>rd</sup> Convocation – Mr. Pankaj
                                    Patel
                                  </h6>
                                </Col>
                              </Row>
                              <Row className="p-2">
                                ...
                                <Col md={10}>
                                  <p>
                                    3<sup>rd</sup> Convocation of CHARUSAT was
                                    celebrated on January 11, 2014 (Academic
                                    Year 2012-13). The occasion was graced by
                                    Mr. Pankaj Patel, Chairman and Managing
                                    Director of ZydusCadila Healthcare Ltd as
                                    the Chief Guest.{" "}
                                    <p>
                                      In all, 27 students with academic
                                      excellence were awarded with Gold Medals
                                      and 1288 students from 6 faculties
                                      including students of M. Phil and Ph. D
                                      were awarded with the degrees.
                                    </p>
                                  </p>
                                </Col>
                              </Row>
                              ...
                              <Row className="p-2">
                                <Col>
                                  <hr />
                                  <h6 className=" p-1">
                                    02<sup>nd</sup> Convocation – DR. R A
                                    Mashelkar
                                  </h6>
                                </Col>
                              </Row>
                              <Row className="p-2">
                                ...
                                <Col md={10}>
                                  <p>
                                    2<sup>nd</sup> Convocation of CHARUSAT was
                                    organized on February 16, 2013 (Academic
                                    Year 2011-12). The occasion was graced by
                                    Dr. R A Mashelkar, National Professor and
                                    President, Global Research Alliance National
                                    Chemical Laboratory as the Chief Guest.
                                    Global Research Alliance National Chemical
                                    Laboratory is a network of publicly funded
                                    R&D institutes from Asia-Pacific, Africa,
                                    Europe and USA with over 60,000 scientists.
                                    390 students from 5 different faculties of
                                    CHARUSAT were awarded with the degrees.
                                    Importantly, 13 students with academic
                                    excellence were awarded with different Gold
                                    Medals.
                                  </p>
                                </Col>
                              </Row>
                              ...
                              <Row className="p-2">
                                <Col>
                                  <hr />
                                  <h6 className="p-1">
                                    01<sup>st</sup> Convocation – Dr. APJ Abdul
                                    Kalam
                                  </h6>
                                </Col>
                              </Row>
                              <Row className="p-2">
                                ...
                                <Col md={10}>
                                  <p>
                                    The 1<sup>st</sup> Convocation of CHARUSAT
                                    was held on January 18, 2012 (Academic Year
                                    2010-11). In all, 160 students from Faculty
                                    of Technology and Engineering, Faculty of
                                    Pharmacy, Faculty of Management Studies, and
                                    Faculty of Applied Sciences were awarded
                                    with Bachelor and Master Degrees. Students
                                    with highest CGPA were awarded with gold
                                    medals. In all, 8 gold medals were awarded
                                    to the deserving students. The occasion was
                                    graced by the presence of the Former
                                    President, India; Architect of the Missile
                                    Programme of India; and Bharat Ratna Dr. APJ
                                    Abdul Kalam the Chief Guest.
                                  </p>
                                </Col>
                              </Row>
                            </Container>
