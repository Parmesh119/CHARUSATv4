...
const commentList = [
  ...
  // },
  {
    ...
    link: "https://charusat.ac.in/iqac/nirf/NIRF2024/CHARUSAT_NIRF_2024.pdf",
  },
  {
    desc: "NIRF India Ranking 2023",
    link: "https://charusat.ac.in/iqac/nirf/NIRF2023/CHARUSAT_NIRF_2023.pdf",
  },
            ...
            <div className="com-content">
              <div className="com-title">
                <div className="com-title-meta lab-ul">
                  {/* <h6>{val.name}</h6>
                                    <span> {val.date} </span> */}
                  <a href={val.link} className="csdc-left" target="_blank">
                    <span>{val.desc}</span>
                  </a>
                </div>
              </div>
